...
#endif
		default:
			current_screen_size = MRLE_CreateFrame((const UBYTE *)Screen_atari, current_is_keyframe, rle_buffer, rle_buffer_size, reference_screen, video_width, video_height, video_left_margin, video_top_margin);
			break;
	}
