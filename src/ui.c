...
{
	static UI_tMenuItem menu_array[] = {
		UI_MENU_ACTION(CARTRIDGE_STD_8, "Standard 8 KB cartridge"),
		UI_MENU_ACTION(CARTRIDGE_STD_16, "Standard 16 KB cartridge"),
		UI_MENU_ACTION(CARTRIDGE_OSS_034M_16, "OSS two chip 16 KB cartridge (034M)"),
		UI_MENU_ACTION(CARTRIDGE_5200_32, "Standard 32 KB 5200 cartridge"),
		UI_MENU_ACTION(CARTRIDGE_DB_32, "DB 32 KB cartridge"),
		UI_MENU_ACTION(CARTRIDGE_5200_EE_16, "Two chip 16 KB 5200 cartridge"),
		UI_MENU_ACTION(CARTRIDGE_5200_40, "Bounty Bob 40 KB 5200 cartridge"),
		UI_MENU_ACTION(CARTRIDGE_WILL_64, "64 KB Williams cartridge"),
		UI_MENU_ACTION(CARTRIDGE_EXP_64, "Express 64 KB cartridge"),
		UI_MENU_ACTION(CARTRIDGE_DIAMOND_64, "Diamond 64 KB cartridge"),
		UI_MENU_ACTION(CARTRIDGE_SDX_64, "SpartaDOS X 64 KB cartridge"),
		UI_MENU_ACTION(CARTRIDGE_XEGS_32, "XEGS 32 KB cartridge"),
		UI_MENU_ACTION(CARTRIDGE_XEGS_64, "XEGS 64 KB cartridge"),
		UI_MENU_ACTION(CARTRIDGE_XEGS_128, "XEGS 128 KB cartridge"),
		UI_MENU_ACTION(CARTRIDGE_OSS_M091_16, "OSS one chip 16 KB cartridge"),
		UI_MENU_ACTION(CARTRIDGE_5200_NS_16, "One chip 16 KB 5200 cartridge"),
		UI_MENU_ACTION(CARTRIDGE_ATRAX_128, "Atrax 128 KB cartridge"),
		UI_MENU_ACTION(CARTRIDGE_BBSB_40, "Bounty Bob 40 KB cartridge"),
		UI_MENU_ACTION(CARTRIDGE_5200_8, "Standard 8 KB 5200 cartridge"),
		UI_MENU_ACTION(CARTRIDGE_5200_4, "Standard 4 KB 5200 cartridge"),
		UI_MENU_ACTION(CARTRIDGE_RIGHT_8, "Right slot 8 KB cartridge"),
		UI_MENU_ACTION(CARTRIDGE_WILL_32, "32 KB Williams cartridge"),
		UI_MENU_ACTION(CARTRIDGE_XEGS_256, "XEGS 256 KB cartridge"),
		UI_MENU_ACTION(CARTRIDGE_XEGS_512, "XEGS 512 KB cartridge"),
		UI_MENU_ACTION(CARTRIDGE_XEGS_1024, "XEGS 1 MB cartridge"),
		UI_MENU_ACTION(CARTRIDGE_MEGA_16, "MegaCart 16 KB cartridge"),
		UI_MENU_ACTION(CARTRIDGE_MEGA_32, "MegaCart 32 KB cartridge"),
		UI_MENU_ACTION(CARTRIDGE_MEGA_64, "MegaCart 64 KB cartridge"),
		UI_MENU_ACTION(CARTRIDGE_MEGA_128, "MegaCart 128 KB cartridge"),
		UI_MENU_ACTION(CARTRIDGE_MEGA_256, "MegaCart 256 KB cartridge"),
		UI_MENU_ACTION(CARTRIDGE_MEGA_512, "MegaCart 512 KB cartridge"),
		UI_MENU_ACTION(CARTRIDGE_MEGA_1024, "MegaCart 1 MB cartridge"),
		UI_MENU_ACTION(CARTRIDGE_SWXEGS_32, "Switchable XEGS 32 KB cartridge"),
		UI_MENU_ACTION(CARTRIDGE_SWXEGS_64, "Switchable XEGS 64 KB cartridge"),
		UI_MENU_ACTION(CARTRIDGE_SWXEGS_128, "Switchable XEGS 128 KB cartridge"),
		UI_MENU_ACTION(CARTRIDGE_SWXEGS_256, "Switchable XEGS 256 KB cartridge"),
		UI_MENU_ACTION(CARTRIDGE_SWXEGS_512, "Switchable XEGS 512 KB cartridge"),
		UI_MENU_ACTION(CARTRIDGE_SWXEGS_1024, "Switchable XEGS 1 MB cartridge"),
		UI_MENU_ACTION(CARTRIDGE_PHOENIX_8, "Phoenix 8 KB cartridge"),
		UI_MENU_ACTION(CARTRIDGE_BLIZZARD_16, "Blizzard 16 KB cartridge"),
		UI_MENU_ACTION(CARTRIDGE_ATMAX_128, "Atarimax 128 KB Flash cartridge"),
		UI_MENU_ACTION(CARTRIDGE_ATMAX_1024, "Atarimax 1 MB Flash cartridge"),
		UI_MENU_ACTION(CARTRIDGE_SDX_128, "SpartaDOS X 128 KB cartridge"),
		UI_MENU_ACTION(CARTRIDGE_OSS_8, "OSS 8 KB cartridge"),
		UI_MENU_ACTION(CARTRIDGE_OSS_043M_16, "OSS two chip 16 KB cartridge (043M)"),
		UI_MENU_ACTION(CARTRIDGE_BLIZZARD_4, "Blizzard 4 KB cartridge"),
		UI_MENU_ACTION(CARTRIDGE_AST_32, "AST 32 KB cartridge"),
		UI_MENU_ACTION(CARTRIDGE_ATRAX_SDX_64, "Atrax SDX 64 KB cartridge"),
		UI_MENU_ACTION(CARTRIDGE_ATRAX_SDX_128, "Atrax SDX 128 KB cartridge"),
		UI_MENU_ACTION(CARTRIDGE_TURBOSOFT_64, "Turbosoft 64 KB cartridge"),
