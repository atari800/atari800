  Free and portable Atari 800 Emulator for everybody, Version 2.0.2
  -----------------------------------------------------------------

    Copyright (C) 1995 David Firth. E-Mail: david@signus.demon.co.uk
    Copyright (C) 1998-2006 Atari800 Development Team.
...
This is the version 2.0.2 of the Atari 800, 800XL, 130XE and 5200 emulator
for Unix, Linux, Amiga, MS-DOS, Atari TT/Falcon, MS Windows, MS WinCE
and systems running the SDL library. Our main objective is to create
a freely distributable portable emulator (i.e. with source code available).
It can be configured to run in the following ways :-

	1. BASIC mode
	2. CURSES Mode
	3. SVGALIB for Linux Systems
	4. X Window + Optional XVIEW or MOTIF User Interface
	5. CBM Amiga
 	6. MS-DOS
...
a User Interface implemented on the emulator's "screen". The User
...
o 42 cartridge types, raw and CART format.
